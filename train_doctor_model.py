...
out_model_name = 'doctor_v4.pt'
data_path = './data_v2.txt'
...
# 保存模型
torch.save(model.state_dict(), 'doctor_v3.pt')
...
# # 加载训练好的模型参数
model.load_state_dict(torch.load('doctor_v3.pt'), strict=False)
